    ...
    <div class="row">
      ...
      <div class="col-md-9 col-md-offset-1">
        <div class="grid-title no-border">
          <h3>Benodigdheden Facebook tab-app aanpassen</h3>
        </div>
          ...
          <div class="container">
            ...
            <div class="container" style="margin: 0; overflow: hidden; position: relative;">
              <div id="fieldset-holder" style="display: block; float: left; overflow: hidden; width: 10000px;">
                ...
                {!! Form::model($benodigd, array('class'=>'form-registreren', 'action'=> ['Member\MemberBenodigdhedenController@update',$benodigd->id], 'files'=>true, 'method'=>'PATCH')) !!}
