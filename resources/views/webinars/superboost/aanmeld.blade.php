  ...
  <div class="container">
    <div class="row login-container animated fadeInUp"> 
      <div class="col-md-10 col-md-offset-1 tiles white" style="padding:25px"> 
        ...
        <p>Ontdek tijdens het live event hoe je:</p>
        <ul class="wink">
          <li class="vink">Het bereik van je Facebookpagina vergroot.</li>
          <li class="vink">Betrokkenheid met je Facebookfans vergroot.</li>
          <li class="vink">Een (nieuw) product, evenement of (nieuwe) dienst onder de aandacht brengt.</li>
          <li class="vink">In contact komt met Facebookvrienden van fans en bestaande klanten.</li>
          <li class="vink">Feedback over je product, evenement of dienst verzamelt.</li>
          <li class="vink">De naamsbekendheid van jouw bedrijf vergroot.</li>
        </ul>
        {{-- <div class="clearfix"></div>
        <hr>
      ...
      <div class="col-md-10 col-md-offset-1" style="margin-top: 25px; padding: 25px;">
        <p style="margin:0;">Dit online event is <u>Live</u> en zal niet worden opgenomen. <b>Dus zorg dat je erbij bent!</b> We zullen aan het eind van het online event tijd vrij maken om al jouw vragen te beantwoorden.</p>
      </div>
      <div class="col-md-10 col-md-offset-1">
        <center><button class="btn demo-button aanmelden-seminar">Claim Jouw Plek!</button></center>
      </div>
...
@include('includes.forms.webinars.superboost.aanmelden')
  <script>
  ...
  $('form#superboost-aanmeld').submit(function (e) {
      e.preventDefault();
      ...
      $.ajax({
        type: 'POST',
        url: '/superboost',
        data: $('form#superboost-aanmeld').serialize(),
        dataType: 'json',
        ...
        $.ajax({
          ...
          success: function(data){
            if(data['result'] != "success") {
              ...
              $('form#superboost-aanmeld').slideUp();
              $('div.titel h2').empty();
