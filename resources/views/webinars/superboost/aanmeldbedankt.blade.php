  ...
  <div class="container">
    <div class="row login-container animated fadeInUp"> 
      <div class="col-md-10 col-md-offset-1 tiles white" style="padding:25px"> 
        ...
        <p>Jouw plekje is gereserveerd! :)</p>
      </div>
      <div class="col-md-10 col-md-offset-1 tiles white" style="margin-top: 25px; padding: 25px;">
        <h4>Voeg dit exclusieve online event toe aan jouw agenda en zorg er voor dat je het niet mist!</h4>
        <div class="col-md-4">
            <div class="form-group col-md-12 ical agenda">
              <a href="http://www.digitusmarketing.nl/uploads/webinar/Online Event - De Theorie Achter Het Bereik Op Facebook.ics">
          ...
          <div class="col-md-4">
            <div class="form-group col-md-12 google-calendar agenda">
              <a href="https://www.google.com/calendar/event?action=TEMPLATE&text=Online+Event+-+De+Theorie+Achter+Het+Bereik+Op+Facebook&dates=20151118T183000Z/20151118T200000Z&details=Wij+verheugen+ons+al+op+het+online+event!%0A+%0AHoud+je+mailbox+in+de+gaten,+we+sturen+je+tijdig+een+email+met+daarin+alle+informatie+dat+nodig+is+om+het+online+event+bij+te+wonen.%0A+%0AWe+zien+je+snel!%0A+%0A-+Parsifal+Tritsch+en+Rogier+van+Voorst&location=http://www.digitusmarketing.nl/superboost/webinar" target="_blank">
