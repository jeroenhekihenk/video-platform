			...
			<div class="introductie" style="float:left;">
				...
				<div class="planbg button float"><!--planbg div begins here!-->
					...
					<div class="features">
						...
						<li class="plancolor"><span class="fa fa-times red"></span> Facebook tab (T.w.v. &euro;350,-)</li>
						<li><span class="fa fa-times red"></span> VIP Coaching (8x strategie sessie á 1 uur)</li>
					</div>
					<!--Features List Ends here!-->
					<div class="pricing">
						<table>
							<tr>
								<td align="right"><p>Normaal</p></td>
								<td align="left"><span class="skinonecolor"><strike>&euro;597,-</strike></span></td>
							</tr>
							<tr>
								<td align="right"><p>Nu</p></td>
								<td align="left"><span class="skinonecolor">&euro;397,-</span></td>
							</tr>
						</table>
					</div>
					<div class="requestbg skinonerequest">
						<li><button class="btn demo-button koop-button aanmeld-button" data-pakket-id="1" data-pakket-omschrijving="Basis cursus" data-pakket-bedrag="397.00" data-titel="Basis pakket">Ik wil aan de slag!</button></li>
					</div>
				...
				<div class="planbg planborder skinonebg float aanbevolen"><!--planbg div begins here!-->
					...
					<div class="features skinonefeatures">
						...
						<li><span class="fa fa-times red"></span> Facebook tab (T.w.v. &euro;350,-)</li>
						<li class="skinoneplancolor"><span class="fa fa-times red"></span> VIP Coaching (8x strategie sessie á 1 uur)</li>
					</div>
					<!--Features List Ends here!-->
					<div class="pricing">
						<table>
							<tr>
								<td align="right"><p>Normaal</p></td>
								<td align="left"><span class=""><strike>&euro;797,-</strike></span></td>
							</tr>
							<tr>
								<td align="right"><p>Nu</p></td>
								<td align="left"><span class="">&euro;497,-</span></td>
							</tr>
						</table>
					</div>
					<div class="requestbg skinonerequest skinonefeaturedreq">
						<li><button class="btn demo-button koop-button aanmeld-button" data-pakket-id="2" data-pakket-omschrijving="Geavanceerde cursus" data-pakket-bedrag="497.00" data-titel="Geavanceerde pakket">Ik wil aan de slag!</button></li>
					</div>
				</div><!--planbg div ends here!-->
				<div class="planbg button float"><!--planbg div begins here!-->
					<div class="topbar skinonebg"></div>
...
<div id="aan-de-slag">
	<div class="container">
		<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
			...
			{{-- <div class="col-md-6">
				<h2>Basis Cursus</h2>
				<h3 class="prijs">Normaal: <strike>&euro; 897,-</strike></h3>
				<h3 class="prijs">NU tijdelijk voor slechts &euro; 197,-!</h3>
			</div>
			<div class="col-md-6">
				<h2>Geavanceerde Cursus</h2>
				<h3 class="prijs">Normaal: <strike>&euro; 1197,-</strike></h3>
				<h3 class="prijs">NU tijdelijk voor slechts &euro; 297,-!</h3>
			</div> --}}
			<div class="col-md-12">
				<h2>Ik wil aan de slag met het:</h2>
			</div>
			<div class="col-md-4"><button class="btn demo-button koop-button aanmeld-button" data-pakket-id="1" data-pakket-omschrijving="Basis cursus" data-titel="Basis pakket" data-pakket-bedrag="397.00" style="float:right;">Basis pakket</button></div>
			<div class="col-md-4"><button class="btn demo-button koop-button aanmeld-button" data-pakket-id="2" data-pakket-omschrijving="Geavanceerde cursus" data-titel="Geavanceerde pakket" data-pakket-bedrag="497.00" style="float:none;">Geavanceerde pakket</button></div>
			<div class="col-md-4"><button class="btn demo-button koop-button aanmeld-button" data-pakket-id="3" data-pakket-omschrijving="VIP - Coaching pakket in 2 termijnen" data-pakket-bedrag="998.50" data-titel="VIP - Coaching pakket" style="float:left;">VIP - Coaching pakket</button></div>
			{{-- <div class="col-md-12">
				<button class="white-transparent btn aanmeld-button">NU DIRECT AAN DE SLAG!</button>
			</div> --}}
			<div class="clearfix"></div>
			<hr>
...
<div id="aanmeld-formulier" class="aanmeld-formulier">
	<div class="container">
		...
		<h2>Aanmelden Cursus Succesvolle Facebook Tijdlijnacties</h2>
			{!! Form::open(array('action'=>'Webinar\WebinarController@postHetAanbod')) !!}
			<div class="col-md-12">
			...
			<div class="form-group col-md-12">
				{!! Form::label('email', 'Emailadres:') !!} <small>Gebruik het e-mailadres waar je je mee hebt aangemeld voor het webinar!</small>
