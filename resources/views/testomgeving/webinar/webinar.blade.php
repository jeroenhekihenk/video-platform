  ...
  <div class="container">
    <div class="row login-container animated fadeInUp"> 
      <div class="col-md-12 tiles white" style="padding:15px;"> 
        ...
        @foreach($hetwebinar->producten as $product)
          <a href="{!! action('TestOmgeving\TestOmgevingController@getBestel', $product->slug) !!}">Bestelpagina</a>
          <a href="{!! action('TestOmgeving\TestOmgevingController@getBestellen', $product->slug) !!}">Salespage</a>
        @endforeach
      </div>      
    </div>
  </div>
