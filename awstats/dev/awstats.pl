...
sub Read_Config {
	...
	# Standard, Mandrake and Debian package :	"/home/id00005/domains/digitusmarketing.nl/awstats/dev/.data"
	# Other possible directories :				"/usr/local/etc/awstats", "/etc"
	# FHS standard, Suse package : 				"/etc/opt/awstats"
	my $configdir         = shift;
	my @PossibleConfigDir = (
			"$DIR",
			"/home/id00005/domains/digitusmarketing.nl/awstats/dev/.data",
